...
class UnpublishedTab extends StatefulWidget {
  const UnpublishedTab({super.key});

  @override
  State<UnpublishedTab> createState() => _UnpublishedTabState();
}

class _UnpublishedTabState extends State<UnpublishedTab> {
  ...
  Future<void> _publishProduct(String docId) async {
    if (!mounted) return;
    try {
      try {
      ...
      child: StreamBuilder<QuerySnapshot>(
        ...
        builder: (context, snapshot) {
          ...
          return ListView.builder(
            key: const PageStorageKey('unpublished_list'),
